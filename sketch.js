...
function createAccio() {
  ...
  var Accio = createSprite(Math.round(random(1,4),40, 10, 10));
...
function createExpelliarmus() {
  ...
  var Expelliarmus = createSprite(Math.round(random(1,4),40, 10, 10));
...
function createExpecto() {
  if (World.frameCount % 320 == 0) {
  var Expecto = createSprite(Math.round(random(1,4),40, 10, 10));
...
function createAvada() {
  if (World.frameCount % 320 == 0) {
  var Avada = createSprite(Math.round(random(1,4),40, 10, 10));
